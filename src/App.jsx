...
.sidebar-link:hover { color: var(--text); border-left-color: var(--muted); }
...
.body p { margin: 0; color: #d6d3d1; line-height: 1.9; font-size: 17px; }
.body .lead { font-size: 32px; color: var(--text); }
.grid {
  margin-top: 36px;
  display: grid;
...
.timeline { margin-top: 36px; border: 1px solid var(--border); background: var(--panel); }
.timeline-item { padding: 18px 20px; color: #d6d3d1; line-height: 1.8; }
...
.modal-text p { margin: 0 0 24px 0; color: #d6d3d1; line-height: 1.9; font-size: 17px; }
.sources { margin-top: 28px; border-top: 1px solid var(--border); padding-top: 18px; }
.source-item { margin-top: 8px; font-size: 14px; line-height: 1.8; color: var(--muted); }
.source-link { color: #d6d3d1; text-decoration: underline; text-underline-offset: 4px; }
.errorbox {
...
@media (max-width: 960px) {
  ...
  .modal-side { border-right: none; border-bottom: 1px solid var(--border); }
}
`;
    ...
    objects: [
      {
        ...
        excerpt: "The coin does not pretend. Athens puts wisdom on its silver. Other cities put force, lineage, or divine favor. Naxos puts wine.",
        imageSrc: "/coins/Naxos.jpg",
        imageAlt: "Silver tetradrachm of Naxos showing Dionysus and Silenus.",
        imageCaption: "Silver tetradrachm of Naxos, c. 461 BCE. Dionysus on the obverse and Silenus on the reverse.",
...
I buy two amphoras, a sack of almonds, and keep one tetradrachm aside for myself. Not because it is the most valuable coin I handle that spring, but because Silenus seems like the right companion for a long return voyage.`,
        citations: [
          { label: "The Metropolitan Museum of Art, Heilbrunn Timeline of Art History, resources on ancient Sicily and Greek coinage.", url: "https://www.metmuseum.org/toah/" },
          { label: "The British Museum, collection records for Greek coinage from Sicily.", url: "https://www.britishmuseum.org/collection" }
        ]
      },
      {
        slug: "athens",
        ...
        excerpt: "The city needs no speech. The type has remained remarkably consistent, and that consistency is its own argument.",
        imageSrc: "/coins/Athens-Owl.jpg",
        imageAlt: "Athenian owl tetradrachm with Athena on the obverse and owl on the reverse.",
        imageCaption: "Athenian owl tetradrachm, c. 440 BCE. Athena on the obverse and owl on the reverse.",
...
I spend six weeks in Athens and leave richer than I arrived, though not enough to enjoy the city as Athenians enjoy themselves. Still, I leave with respect. A city that can send out silver so reliable that strangers trust it by habit has done something most rulers fail to do with armies.`,
        citations: [
          { label: "The British Museum, collection records for Athenian owl tetradrachms.", url: "https://www.britishmuseum.org/collection" },
          { label: "The Metropolitan Museum of Art, essays and collection resources on ancient Greek trade and coinage.", url: "https://www.metmuseum.org/toah/" }
        ]
      },
      {
        slug: "akragas",
        ...
        excerpt: "I stand in a city that imagines itself the eagle and not the hare.",
        imageSrc: "/coins/Akragas.jpg",
        imageAlt: "Silver dekadrachm of Akragas with quadriga and eagle imagery.",
        imageCaption: "Silver dekadrachm of Akragas, c. 409 BCE. Quadriga and eagle imagery.",
...
I stand in a city that imagines itself the eagle and not the hare. Still, the market that week is full of hurried sales, and hurried sales are a form of truth. I leave before the siege begins.`,
        citations: [
          { label: "ToposText, entry on Akragas.", url: "https://topostext.org/place/373136PAkr" },
          { label: "The British Museum, Greek coin collection resources.", url: "https://www.britishmuseum.org/collection" }
        ]
      }
    ]
  },
    ...
    objects: [
      {
        ...
        excerpt: "Military success frightens people, but athletic victory flatters them.",
        imageSrc: "/coins/Philip-II.jpg",
        imageAlt: "Silver tetradrachm of Philip II with Zeus and horseman.",
        imageCaption: "Silver tetradrachm of Philip II, c. 342 BCE. Zeus on the obverse and horseman on the reverse.",
...
What strikes me most is the restraint. Philip does not place his own face on the coin. Zeus is still Zeus, and Philip is still below him, however much the king may benefit from standing nearby.`,
        citations: [
          { label: "The Metropolitan Museum of Art, collection resources on Philip II coinage.", url: "https://www.metmuseum.org/toah/" },
          { label: "Harvard Art Museums, collection records.", url: "https://harvardartmuseums.org/collections" }
        ]
      },
      {
        ...
        imageCaption: "Silver tetradrachm of Alexander III, c. 325 BCE. Herakles on the obverse and Zeus on the reverse.",
...
That is what impresses me most. Not the beauty of a single specimen, though it is handsome enough, but the multiplication. One coin is persuasion. Ten thousand are atmosphere.`,
        citations: [
          { label: "Encyclopaedia Britannica, entry on Babylon.", url: "https://www.britannica.com/place/Babylon-ancient-city-Mesopotamia-Asia" },
          { label: "The British Museum, collection records for Alexander coinage.", url: "https://www.britishmuseum.org/collection" }
        ]
      },
      {
        slug: "ptolemy",
        ...
        excerpt: "Dead men are useful in politics, especially very great dead men.",
        imageSrc: "/coins/Ptolemy.jpg",
        imageAlt: "Silver tetradrachm of Ptolemy as satrap with Alexander portrait and Athena reverse.",
        imageCaption: "Silver tetradrachm of Ptolemy as satrap, c. 318 BCE. Alexander portrait on the obverse and Athena on the reverse.",
...
It is not simply memorial coinage. It is interpretation. Ptolemy is not yet saying openly that he is king in his own right. He is saying something more skillful: that he is the proper keeper of what Alexander made. I admire the intelligence of it and mistrust it for the same reason. Dead men are useful in politics, especially very great dead men.`,
        citations: [
          { label: "Encyclopaedia Britannica, history of Alexandria.", url: "https://www.britannica.com/place/Alexandria-Egypt/History" },
          { label: "Harvard Art Museums, collection records.", url: "https://harvardartmuseums.org/collections" }
        ]
      },
      {
        ...
        excerpt: "The dead can continue ruling a market long after they have ceased ruling anything else.",
        imageSrc: "/coins/Alexander-Sardis.jpg",
        imageAlt: "Posthumous Alexander tetradrachm from Sardis.",
        imageCaption: "Posthumous Alexander tetradrachm from Sardis, c. 317 BCE.",
...
A coin does not care whether the body behind its claim still breathes. If the type remains trusted, the argument remains alive. The dead can continue ruling a market long after they have ceased ruling anything else.`,
        citations: [
          { label: "Sardis Expedition, history and chronology resources.", url: "https://sardisexpedition.org/" },
          { label: "The British Museum, collection resources on Hellenistic coinage.", url: "https://www.britishmuseum.org/collection" }
        ]
      }
    ]
  },
    ...
    objects: [
      {
        ...
        excerpt: "Why teach people a new language of power when the old one still spends?",
...
I do not despise the coin for this. A merchant has little right to despise effective continuity. Still, I cannot help feeling that I am watching inheritance become imitation, and imitation become rule.`,
        citations: [
          { label: "Harvard Art Museums, collection records.", url: "https://harvardartmuseums.org/collections" },
          { label: "The British Museum, Hellenistic coin collection resources.", url: "https://www.britishmuseum.org/collection" }
        ]
      },
      {
        slug: "lysimachos",
        ...
        imageCaption: "Silver tetradrachm of Lysimachos, c. 285 BCE. Alexander portrait on the obverse and Athena on the reverse.",
...
What astonishes me is the date of it all. Alexander has been dead for decades, yet he is still the most persuasive face available to power. Lysimachos must still borrow authority from the dead youth he once followed.`,
        citations: [
          { label: "The British Museum, collection records for Lysimachos coinage.", url: "https://www.britishmuseum.org/collection" },
          { label: "Harvard Art Museums, collection records.", url: "https://harvardartmuseums.org/collections" }
        ]
      }
    ]
    ...
    objects: [
      {
        ...
        excerpt: "When power grows fully impatient, it ceases even to clothe itself properly.",
        imageSrc: "/coins/Brutus.jpg",
        imageAlt: "Brutus Eid Mar denarius with portrait and daggers.",
        imageCaption: "Denarius of Brutus, Eid Mar, 42 BCE. Brutus portrait on the obverse and daggers with pileus on the reverse.",
...
I set the coin beside the old Naxos tetradrachm on my table. Silenus lifts his cup. Brutus raises his murder into silver. Between them lies all the distance from the old Greek world to Rome. If the earlier writers are right, coins outlast the men who strike them. I think, tonight, that they also outlast the excuses.`,
        citations: [
          { label: "Livius, Philippi (42 BCE).", url: "https://www.livius.org/articles/battle/philippi-42-bce/" },
          { label: "The British Museum, collection records for the Eid Mar denarius.", url: "https://www.britishmuseum.org/collection" }
        ]
      }
    ]
  },
...
function CoinImage({ object, card }) {
...
function MuseumApp() {
  ...
  const allObjects = useMemo(() => {
    return sections.flatMap((section) => section.objects || []);
  }, []);
              ...
              {section.body ? (
                <div className="body">
                  {section.body.map((paragraph, index) => (
                    <p key={`${section.id}-${index}`} className={index === 0 && section.id === "intro" ? "lead" : ""}>
                      {paragraph}
                    </p>
                  ))}
                </div>
                  ...
                  {section.objects.map((object) => {
                    ...
                    return (
                      <article key={object.slug} className="card">
                        ...
                        <CoinImage object={object} card={true} />
                        ...
                        <button className="btn" onClick={() => setSelectedObject(object)}>
                          Read full entry
                        </button>
                      </article>
                    );
              ...
              {section.timeline ? (
                <div className="timeline">
                  {section.timeline.map((item, index) => (
                    <div key={`${section.id}-timeline-${index}`} className="timeline-item">
                      {item}
                    </div>
                  ))}
                </div>
          ...
          <div className="backdrop" onClick={() => setSelectedObject(null)}>
            <div className="modal" onClick={(e) => e.stopPropagation()}>
              <div className="modal-header">
                ...
                <button className="btn" onClick={() => setSelectedObject(null)}>
                  Close
                </button>
              </div>
              ...
              <div className="modal-body">
                <div className="modal-side">
                  <CoinImage object={activeObject} card={false} />
